...
void SysOperationBridge_invokeOriginalMethodNative(const u4* args, JValue* pResult, const Method* method, ::Thread* self);
...
bool onVmCreated(JNIEnv* env) {
    ...
    Method* sysoperationInvokeOriginalMethodNative = (Method*) env->GetStaticMethodID(classSysOperationBridge, "invokeOriginalMethodNative",
    ...
    dvmSetNativeFunc(sysoperationInvokeOriginalMethodNative, SysOperationBridge_invokeOriginalMethodNative, NULL);
...
void hookedMethodCallback(const u4* args, JValue* pResult, const Method* method, ::Thread* self) {
    ...
    JValue result;
    dvmCallMethod(self, (Method*) methodSysOperationBridgeHandleHookedMethod, NULL, &result,
...
void SysOperationBridge_hookMethodNative(JNIEnv* env, jclass clazz, jobject reflectedMethodIndirect,
 ...
 */
void SysOperationBridge_invokeOriginalMethodNative(const u4* args, JValue* pResult,
