...
bool onVmCreated(JNIEnv*) {
    ...
    ArtMethod::xposed_callback_method = methodSysOperationBridgeHandleHookedMethod;
    return true;
}
...
jobject SysOperationBridge_invokeOriMethodNative(JNIEnv* env, jclass, jobject javaMethod,
...
void SysOperationBridge_closeFilesBeforeForkNative(JNIEnv*, jclass) {
    gClosedFdTable = FileDescriptorTable::Create();
}

void SysOperationBridge_reopenFilesAfterForkNative(JNIEnv*, jclass) {
